        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    STATUSPEDIDOEXAME = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OBSERVACOES = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    PedidoExameId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EXAME", x => x.ID);
                    table.ForeignKey(
                        name: "FK_EXAME_PEDIDOEXAME_PedidoExameId",
